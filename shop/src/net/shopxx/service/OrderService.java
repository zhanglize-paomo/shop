...
public interface OrderService extends BaseService<Order, Long> {
	 ...
	 * @return 订单
	 */
	List<Order> create(Order.Type type, Cart cart, Receiver receiver, PaymentMethod paymentMethod, ShippingMethod shippingMethod, CouponCode couponCode, Invoice invoice, BigDecimal balance, String memo,Date shippingDate);
