        ...
        $().ready(function() {
            ...
            $productImageFile.fileinput({
                ...
                initialPreviewConfig: $.map(productImages, function(productImage, i) {
                    return {
                        url: "${base}/admin/product/delete_product_image",
                        key: i
                    }
                }),
...
<body class="hold-transition sidebar-mini">
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <form id="productForm" class="form-horizontal" action="${base}/admin/product/update" method="post">
                                            ...
                                            <input id="weight" name="weight" class="form-control" type="text" value="${product.weight}" maxlength="9" title="${message("business.product.weightTitle")}">
												...
												[#else]
													<div class="form-group">
                                                        ...
                                                        <div class="col-xs-4">
                                                            <div class="input-group">
                                                                <input id="stock" name="sku.stock" class="form-control" type="text" value="${product.defaultSku.stock}" maxlength="9" title="${message("Sku.allocatedStock")}: ${product.defaultSku.allocatedStock}" >
                                                               [#-- <div class="input-group-btn">
