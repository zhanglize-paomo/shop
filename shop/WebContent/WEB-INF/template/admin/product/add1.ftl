        ...
        ,
            layoutTemplates: {
                footer: '<div class="file-thumbnail-footer">{inputs}{actions}</div>',
                        actions
            :
                '<div class="file-actions"><div class="file-footer-buttons">{upload} {delete} {zoom} {other}</div></div>'
            }
        ,
            fileActionSettings: {
                showUpload: false,
...
<form id="inputForm" action="save" method="post">
    ...
    <table class="input tabContent">
        ...
        <tr>
            <th>
                <span class="requiredField">*</span>商品分类:
            </th>
            <td>
                <select id="productCategoryId" name="productCategoryId" class="selectpicker form-control"
															...
															[#list productCategoryTree as productCategory]
                                                                [#if allowedProductCategories?seq_contains(productCategory) || allowedProductCategoryParents?seq_contains(productCategory)]
																	<option value="${productCategory.id}"
                                                                            title="${productCategory.name}"[#if !allowedProductCategories?seq_contains(productCategory)]
                                                                            disabled[/#if]>
        ...
        <tr>
            ...
            <td>
                <input id="name" name="name" class="text" type="text" maxlength="200">
            </td>
        </tr>
        <tr>
            <th>
                <span class="requiredField">*</span>销售价格:
            </th>
            <td>
                <input id="price" name="sku.price" class="text" type="text" maxlength="16">
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input id="stock" name="sku.stock" class="text" type="text" value="1" maxlength="9">
            </td>
        </tr>
        <tr>
            <th>
                <span class="requiredField">*</span>${message("business.common.setting")}:
            </th>
            <td>
        ...
        <tr>
            <th>
                <span class="requiredField">*</span>${message("Product.type")}::
            </th>
            <td>
