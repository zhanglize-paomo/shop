...
<head>
	...
	<![endif]-->
	<script src="${base}/resources/admin/js/bus/jquery.js"></script>
	<script src="${base}/resources/admin/js/bus/bootstrap.js"></script>
	<script src="${base}/resources/admin/js/bus/bootstrap-select.js"></script>
	<script src="${base}/resources/admin/js/bus/bootstrap-checkbox-x.js"></script>
	<script src="${base}/resources/admin/js/bus/bootstrap-fileinput.js"></script>
	<script src="${base}/resources/admin/js/bus/velocity.js"></script>
	<script src="${base}/resources/admin/js/bus/velocity.ui.js"></script>
	<script src="${base}/resources/admin/js/bus/summernote.js"></script>
	<script src="${base}/resources/admin/js/bus/sortable.js"></script>
	<script src="${base}/resources/admin/js/bus/jquery.validate.js"></script>
	<script src="${base}/resources/admin/js/bus/icheck.js"></script>
	<script src="${base}/resources/admin/js/bus/underscore.js"></script>
	<script src="${base}/resources/admin/js/bus/adminLTE.js"></script>



    <script type="text/javascript" src="${base}/resources/admin/js/common.js"></script>
    <script type="text/javascript" src="${base}/resources/admin/js/buscommon.js"></script>
	...
	<script type="text/javascript">
		$().ready(function() {
			...
			$productImageFile.fileinput({
				uploadUrl: "${base}/admin/product/upload_product_image",
			...
			function loadParameter() {
				$.ajax({
					url: "${base}/admin/product/parameters",
					type: "GET",
					data: {
			...
			function loadAttribute() {
				$.ajax({
					url: "${base}/admin/product/attributes",
					type: "GET",
					data: {
						productCategoryId: $productCategoryId.val()
					},
			...
			function loadSpecification() {
				$.ajax({
					url: "${base}/admin/product/specifications",
					type: "GET",
					data: {
						productCategoryId: $productCategoryId.val()
					},
			...
			$productForm.validate({
				rules: {
					...
					sn: {
						pattern: /^[0-9a-zA-Z_-]+$/,
						remote: {
							url: "${base}/admin/product/check_sn",
							cache: false
						}
					},
					name: "required",
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12">
                <form id="productForm" class="form-horizontal" action="${base}/admin/product/save" method="post">
