...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/index">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.productCategory.add")}
	</div>
	<form id="inputForm" action="save" method="post">
		<table class="input">
			...
			<input type="hidden" id="generalRate" name="generalRate" value="0" class="text" maxlength="200"/>
			<input type="hidden" id="selfRate" name="selfRate" value="0" class="text" maxlength="200"/>
