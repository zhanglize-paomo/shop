...
<body class="order-checkout">
	<div id="mainPage" class="main-page page">
		<form id="orderForm" action="create" method="post">
			...
			<input id="paymentMethodId" name="paymentMethodId" type="hidden"value="3">
			<input id="shippingMethodId" name="shippingMethodId" type="hidden"value="1">
				...
				<div class="container-fluid">
					...
					<div class="list-group list-group-flat">
						<div class="order list-group-item">
							<a href="javascript:;">当日16点前下单次日送达，16点后下单后日送达</a>
						</div>

						<div class="list-group-item">
							<div class="row">
								<div class="col-xs-3">配送时间</div>
								<div class="col-xs-9">
									<input name="shippingDate" type="date" maxlength="200" placeholder="${message("shop.order.memoPlaceholder")}">
								</div>
							</div>
						</div>
						...
						[#if orderType == "general"]
							...
							[/#if]
							[#--优惠券码<div class="list-group-item">
								<div class="row">
			...
			<div class="footer-fixed">
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-xs-4">
							<button id="submit" class="btn btn-red btn-flat btn-block" type="button">确认提交</button>
						</div>
					</div>
				</div>
			</div>
