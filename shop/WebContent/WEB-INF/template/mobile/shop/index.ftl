		...
		<div class="container-fluid">
			...
			<nav>
				<div class="row">
					...
					<div class="col-xs-3 text-center">
						<a href="${base}/product/list/1">
							<img src="${base}/upload/image/index_nav_1.png" alt="生鲜专场">
							生鲜专场
						</a>
					</div>
					<div class="col-xs-3 text-center">
					...
					<div class="col-xs-10">
						<div class="carousel" data-ride="carousel">
							<ul class="carousel-inner">
								<li class="item active">
									<a href="${base}/product/list/1">
										<em class="blue-dark">促销专场，全部最低价</em>
										新鲜蔬菜最高可抵2000元
									</a>
								</li>
								<li class="item">
									<a href="${base}/product/list/1">
										<em class="blue-dark">新鲜蔬菜生，超值尝鲜</em>
										精致生活，产地精选
									</a>
								</li>
								<li class="item">
									<a href="${base}/product/list/1">
										<em class="blue-dark">四款让人任性的生鲜，达人分享</em>
										忙碌1年，任性1把
									</a>
								</li>
							</ul>
